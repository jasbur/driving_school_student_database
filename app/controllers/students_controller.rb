class StudentsController < ApplicationController
  ...
  def update
    ...
    if student.update_attribute(:first_name, params[:student][:first_name]) and 
      ...
      student.update_attribute(:dob, params[:student][:dob]) and
      student.update_attribute(:phone_1, params[:student][:phone_1]) and
      student.update_attribute(:phone_2, params[:student][:phone_2]) and
      student.update_attribute(:start_date, params[:student][:start_date]) and
      student.update_attribute(:finish_date, params[:student][:finish_date]) and
      ...
      student.update_attribute(:temps_issued, params[:student][:temps_issued]) and
      ...
      student.update_attribute(:date_instructor_assigned, params[:student][:date_instructor_assigned]) and
